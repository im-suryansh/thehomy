				...
				<Carousel fade="true" pause="false" controls="false">
					<Carousel.Item interval="3000">
						...
						<Carousel.Caption className="caption">
							<h3 className="caption-heading">
								Thehomy's Delightful Services for Your Everyday
								Bliss!
							</h3>

							<p className="caption-para">
								We believe in transforming ordinary moments into
								extraordinary memories through our range of
								delightful services. Our mission is simple: to
								make your everyday life blissful and
								stress-free.
					...
					<Carousel.Item interval="3000">
						...
						<Carousel.Caption className="caption">
							...
							<p className="caption-para">
								Step into Thehomy, where we don't just clean
								homes; we build bonds and brighten lives,
								creating a harmonious haven for all. Our
								commitment goes beyond the surface, extending to
					...
					<Carousel.Item interval="3000">
						...
						<Carousel.Caption className="caption">
							...
							<p className="caption-para">
								At Thehomy, we believe in the power of a
								well-cared-for home. Our services extend to
								childcare, providing a safe and nurturing
								environment for your little ones. With our
								dedicated caregivers, you can trust that your
								children are in capable hands.
								<div className="button-carousel-wrapper d-md-block d-none">
									{/* <Button2 name="Explore" className="button-carousel" /> */}
								</div>
							</p>
